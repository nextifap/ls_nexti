...
export function RecomendacaoLivros () {
    return(
        <section className="flex flex-col items-center p-16">
            <h3 className="text-3xl flex flex-col text-center">VISITE NOSSA 
                <span className="text-[#213E60]">
                    ESTANTE VIRTUAL
                </span>
            </h3>

            <p className="md:w-[50%] w-full mb-10 mt-6 text-center">Descubra uma seleção especial de livros e materiais gratuitos para impulsionar seus estudos em tecnologia e programação. Explore conteúdos feitos por especialistas e desenvolva seu aprendizado no seu ritmo.</p>
